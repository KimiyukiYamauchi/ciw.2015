...
1. 画像の種類で、ベクターとビットマップの違いを説明して下さい  
ベクター => 座標を指定して直線、曲線、形状を描画することで、加増を作成  
ビットマップ => 小さなドットを使用して画像を作成
1. クライアントサイドのイメージマップを作成する際に必要なタグを  
３つ書いてください  
```<map>, <area>, <img>```
1. 「画像の透過表示」とは何ですか説明して下さい  
ページの背景が画像の透明色部分を通して見えること
1. 「インターレース」とは何ですか説明して下さい  
Webブラウザ上に画像を表示するときに、ダウンロードに合わせて徐々にはっきり表示させるようにする
1. Web上でアニメーションを実現する技術を３つ挙げて下さい  
アニメーションGIF、Flashアニメーション、Javaアプレット、SVG
